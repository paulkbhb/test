...
output "vcenter_fqdn" {
  value       = module.deploy_vcenter["vcsa01"].vcenter_fqdn
  description = "vCenter FQDN"
}

output "vcenter_user" {
  value       = module.deploy_vcenter["vcsa01"].vcenter_user
  description = "SSO user that was created during the vCenter provisioning"
}

output "vcenter_password" {
  value       = module.deploy_vcenter["vcsa01"].vcenter_password
...
output "vcenter_root_password" {
  value       = module.deploy_vcenter["vcsa01"].vcenter_root_password
